    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        if (json.result == "Success") {
          ...
          swal(
            "Maaf!",
            "Data gagal di" + nact + "..., pesan: " + json.result,
            "error"
          );
        }
      },
      ...
      complete: function (data) {
        ...
        var form = $("#formProductTransfer").get(0);
        if (form) {
          form.reset();
        }
        $("#imgloading").html("");
...
function cart(nomor, kode, nama) {
  ...
  document.getElementById("cart" + nama).value =
    hasil.substr(0, 1) == "-" ? hasil.substr(1) : hasil;
}
  ...
  $.ajax({
    ...
    success: function (data) {
      if (data == "success") {
        ...
        swal("berhasil!", "Data berhasil di" + nact + "...", "error");
      }
    },
    error: function (data) {
      swal("Maaf!", "Proses data berhasil...", "error");
    },
    complete: function (data) {
      $("#bsave").prop("disabled", false);
  ...
  $.ajax({
    ...
    success: function (data) {
      if (data == "success") {
        ...
        swal("Maaf!", "Data gagal di" + nact + "...", "error");
      }
    },
    error: function (data) {
      swal("Maaf!", "Proses data error...", "error");
...
function ceksales() {
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      $("#jatuhtempo").val(json.jatuhtempo);
      $("#dataaddsales").html(
        '<tr id="pilihoutlet"><td colspan="10">Tambah produk...</td></tr>'
      );
    },
    ...
    error: function (data) {
      swal({
        title: "Informasi",
        text: "Outlet ini melebihi limit, mohon hubungi Finance",
        icon: "info",
        button: "OK",
        timer: 5000,
        buttonsStyling: true,
...
function showproduct(
  ...
  $("#detailproduct" + nomor).html(
    kategori + " (" + berat + " " + satuan + ")"
  );
...
function hitungsales(nomor) {
  ...
  var jumlah = bersih($("#pjumlah" + nomor).val()),
    jumlah =
      parseInt(jumlah) == 0 || jumlah == "" || parseInt(jumlah) > parseInt(stok)
        ? 1
        : bersih(jumlah);
  var diskon = $("#pdiskon" + nomor).val(),
    diskon = diskon == "" ? 0 : diskon;
  ...
  if (type != "") {
    if (tapl == "from") {
      ...
      if (type == "IN" && from == self_apl) {
        swal(
          "Warning",
          "Transfer " + type + " harus dari luar " + self_apl_name,
          "warning"
        );
      }
      if (type == "OUT" && from != self_apl) {
        swal(
          "Warning",
          "Transfer " + type + " harus dari " + self_apl_name,
          "warning"
        );
      }
    }
...
function formApprovalTransferStokModal() {
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      if (json.result == "Success") {
        var approvalLabel =
          approval === 1 || approval === "1" ? "Approve" : "Reject";
        swal(
          {
            title: "Selamat!",
  ...
  $.ajax({
    ...
    success: function (data) {
      if (data == "success") {
        ...
        swal("Maaf!", "Data gagal di input...", "error");
      }
    },
    error: function (data) {
      swal("Maaf!", "Proses data error...", "error");
...
function ceksalespenggantianbarang() {
  ...
  $.ajax({
    url:
      usuper + "/ajax/ceksalespenggantianbarang/ceksalespenggantianbarang.php",
    type: "POST",
    async: true,
...
function getproductsalespimtest(
  nomor,
  kode,
  produk,
  nama,
...
// Function to handle approval of transfer retur
...
// Function to handle form submission for transfer retur approval
