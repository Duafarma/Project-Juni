<div class="content-header">
    <div>
        ...
        <h4 class="content-title">Input Data - Dokumen Balik</h4>
    </div>
</div>
...
<div class="content-body">
    <div class="component-section no-code">
        <form id="formdokumen" action="#" method="post"  enctype="multipart/form-data" autocomplete="off">
        <input type="hidden" name="nmenu" id="nmenu" value="dokumenbalik" readonly="readonly" />
         ...
         <div class="row">
            <div class="form-group col-sm-12">
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-sm-4">
                        <a onclick="additemdokumenbalik('tbllegal', 'jumlegal', 'legaldokumen')"><span class="badge badge-success"><i class="fa fa-plus-circle"></i> Add Single</span></a>
                    </div>
                </div>
            </div>
		</div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <a href="<?php echo("$sistem/dokumenbalik"); ?>" title="Batal"><button type="button" class="btn btn-secondary btn-xs">Batal</button></a>
...
function addMultipleRows() {
    var jumlahRow = parseInt(document.getElementById('jumlah_row').value);
    ...
    for (var i = 0; i < jumlahRow; i++) {
        setTimeout(function() {
            additem('tbllegal', 'jumlegal', 'legaldokumen');
            completed++;
            if (completed === jumlahRow) {
                // All rows added, initialize select2
                setTimeout(function() {
                    initializeAllSelect2();
                    alert('Berhasil menambahkan ' + jumlahRow + ' row');
                    document.getElementById('jumlah_row').value = '1';
                }, 200);
            }
        }, i * 100); // Delay each addition by 100ms
    }
}
