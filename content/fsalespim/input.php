<div class="content-header">
    <div>
        ...
        <h4 class="content-title">Input Data - Faktur Penjualan PIM Harga Tayang</h4>
    </div>
</div>
<div class="content-body">
    <div class="component-section no-code">
        ...
        <input type="hidden" name="namamodal" id="namamodal" value="fsalespim" readonly="readonly" />
        ...
        <div class="row row-sm">
            ...
            <div class="col-sm-3">
				...
				<select name="outlet" id="outlet" class="form-control select2" onchange="ceksalespim()" required="required">
            ...
            <div class="col-sm-3 mg-t-10">
                ...
                <input type="checkbox" name="ccp" value="ada"> Ada<br>
                <input type="checkbox" name="ccp" value="tidak ada"> Tidak Ada<br>
            </div>
             <div class="col-sm-3 mg-t-10">
                <label> Cito</label> <span class="tx-danger">*</span></label> <br>
                <input type="checkbox" name="cito" value="cito"> Ya<br>
                <input type="checkbox" name="cito" value="ga cito"> Tidak<br>
            </div>
            <div class="col-sm-3 mg-t-10">
                <label> Harga pim</label> <span class="tx-danger">*</span></label> <br>
                <input type="checkbox" name="hargapim" value="A"> Harga A (Harga Tayang E Catalog)<br>
                <input type="checkbox" name="hargapim" value="B"> Harga B (Harga Nego E Catalog)<br>
                <input type="checkbox" name="hargapim" value="C"> Harga C (Harga Reguler)<br>
            </div>
        </div><!-- row -->
        <div class="clearfix mg-t-25 mg-b-25"></div>
        <div class="row row-sm">
            <div class="col-sm-12">
                <a href="<?php echo("$sistem/fsalespim"); ?>" title="Batal"><button type="button" class="btn btn-secondary">Batal</button></a>
