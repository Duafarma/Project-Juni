...
<div class="content-header">
    <div>
        ...
        <h5>JENIS HARGA : <?php echo($view['hargapim']); ?></h5>
    </div>
</div>
    ...
    <div class="component-section no-code">
        ...
        <div class="row row-sm">
            <div class="col-sm-12">
                ...
                <a onclick="addmaximalpim('addsalespim', 'outlet', 50)"><span class="badge badge-success"><i class="fa fa-plus-circle"></i> Add Data</span></a>
            </div>
        </div>
        <div class="clearfix mg-t-25 mg-b-25"></div>
        <div class="row row-sm">
