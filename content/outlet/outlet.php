...
<div class="content-body">
	<div class="row mg-b-10">
        <div class="col-sm-6">
            ...
            <a target="_blank" href="<?php echo($data->sistem('url_sis')."/laporan/xls/outlet/outletl.php?key=$cari"); ?>" title=".XLS"><button class="btn btn-success btn-pill btn-xs"><i class="fa fa-print"></i> .Legal Data Outlet</button></a>
        ...
        <table class="table table-hover mg-b-0">
            <thead>
                <tr>
                    ...
                    <th>Diskon</th>
                    <th>NPWP</th>
                    <th><center>Diskon Per Item</center></th>
