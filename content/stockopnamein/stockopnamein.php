<div class="content-header">
    <div>
        ...
        <h4 class="content-title">TOTAL INVENTORY - TOTAL STOCK OPNAME</h4>
    </div>
</div>
...
<div class="content-body">
    <div class="row mg-b-10">
        <div class="col-sm-6">
            <a href="<?php echo("$sistem/stockopnamein"); ?>"><button class="btn btn-info btn-pill btn-xs"><i class="fa fa-spinner"></i> Refresh</button></a>
        ...
        <div class="modal-footer">
            ...
            <a href="<?php echo("$sistem/stockopnamein/i"); ?>">  <button type="submit" id="bsave" class="btn btn-success btn-xs">Selesai Stock Opname</button></a>
        </div>
