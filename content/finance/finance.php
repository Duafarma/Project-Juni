...
<div class="content-body">
	<div class="row mg-b-10">
        <div class="col-sm-6">
        	...
        	<a href="#modal1" onclick="<?php echo("caridata('caridata', 'finance', '$cari')"); ?>" data-toggle="modal"><button class="btn btn-warning btn-pill btn-xs"><i class="fa fa-search"></i> Cari Data</button></a> 
