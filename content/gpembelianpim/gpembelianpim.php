<div class="content-header">
    <div>
        ...
        <h4 class="content-title">Pembelian PIM</h4>
    </div>
</div>
<?php
...
<div class="content-body">
	<div class="row mg-b-10">
        <div class="col-sm-6">
			...
			<a href="<?php echo("$sistem/gpembelianpim"); ?>" title="Refresh"><button class="btn btn-info btn-pill btn-xs"><i class="fa fa-spinner"></i> Refresh</button></a>
...
var chart = new Highcharts.Chart({
	...
	title: {
		text: '<?php echo("GRAFIK TRANSAKSI PEMBELIAN PIM"); ?>',
		x: -20 //center
	},
	subtitle: {
	...
	{ 
		...
		<?php
			...
			while($vbulan	= $rbulan->fetch(PDO::FETCH_ASSOC)){
					$jual	= $data->jumlahbelipim($tahun1, $vbulan['id_mbu']) * 1;
					echo("$jual,");
			}
		?>
		]
