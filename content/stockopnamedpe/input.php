<div class="content-header">
    <div>
        ...
        <h4 class="content-title">Input Data - Stockopname DPE</h4>
    </div>
</div>
<!--
    ...
    <div class="component-section no-code">
        <div class="row">
             <div class="form-group col-sm-3">
                ...
                <?php
                $nama_p	= 'MP0000000002';
                $master	= $conn->prepare("SELECT id_pro,nama_p, nama_pro FROM produk WHERE nama_p = :nama_p ORDER BY nama_pro ASC"); 
