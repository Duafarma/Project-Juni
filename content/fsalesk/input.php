<div class="content-header">
    <div>
        ...
        <h4 class="content-title">Input Data - Faktur Konsinyasi</h4>
    </div>
</div>
    ...
    <div class="component-section no-code">
        ...
        <div class="row row-sm">
            ...
            <div class="col-sm-3">
				...
				<select name="outlet" id="outlet" class="form-control select2" onchange="ceksalesk()" required="required">
            ...
            <div class="col-sm-3">
                ...
                <input type="text" name="nomorfaktur" id="fkout" class="form-control" placeholder="Ketik nomor Faktur Konsinyasi di sini..." />
            </div>
            <div class="col-sm-3">
            ...
            <div class="col-sm-3 mg-t-10">
                <label>Tanggal SJ Konsinyasi <span class="tx-danger">*</span></label>
