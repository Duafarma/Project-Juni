<?php
	...
	$read	= $conn->prepare("SELECT sj_tfk, id_out, kode_tfk FROM transaksi_faktur_konsinyasi WHERE id_tfk=:code");
...
<div class="content-header">
    <div>
        ...
        <h4 class="content-title">Input Item - Faktur Konsinyasi</h4>
...
<div class="content-body">
    <div class="component-section no-code">
        ...
        <p class="mg-b-25">Pilih produk yang akan di konsinyasikan</p>
        <div class="row row-sm">
            <div class="col-sm-12">
                ...
                <input type="hidden" name="cartaddsalesk" id="cartaddsalesk" value="" readonly="readonly" />
                <input type="hidden" name="jumaddsalesk" id="jumaddsalesk" value="0" readonly="readonly" />
                <a onclick="addmaximal('addsalesk', 'outlet', 50)"><span class="badge badge-success"><i class="fa fa-plus-circle"></i> Add Data</span></a>
            </div>
        </div>
        <div class="clearfix mg-t-25 mg-b-25"></div>
        <div class="row row-sm">
            <div class="col-sm-12">
                <a href="<?php echo("$sistem/fsalesk"); ?>" title="Batal"><button type="button" class="btn btn-secondary">Batal</button></a>
