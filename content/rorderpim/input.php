<div class="content-header">
    <div>
        ...
        <h4 class="content-title">Input Data - Penerimaan Barang PIM</h4>
    </div>
</div>
<div class="content-body">
    <div class="component-section no-code">
        <h5 id="section1" class="tx-semibold">Informasi Order PIM</h5>
        <p class="mg-b-25">Informasi data-data order.</p>
        <form id="formmenu" action="#" method="post" autocomplete="off">
        <input type="hidden" name="namamodal" id="namamodal" value="rorderpim" readonly="readonly" />
        <input type="hidden" name="namamenu" value="input" readonly="readonly" />
        <div class="row row-sm">
            <div class="col-sm-3">
                <label>Nomor PO <span class="tx-danger">*</span></label>
                <select name="invoice" id="invoice" class="form-control select2" onchange="cariorderpim()" required="required">
        ...
        <div class="row row-sm">
            <div class="col-sm-12">
                <a href="<?php echo("$sistem/rorderpim"); ?>" title="Batal">
