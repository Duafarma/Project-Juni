	...
	-->
        <div class="row row-sm">
            <div class="col-sm-12">
				...
				<?php echo(($data->akses($admin, 'rorderpim', 'A.create_status')==='Active') ? '<a href="#modal1" onclick="crud(\'rorderpim\', \'inputitem\', \''.$uniq.'\')" data-toggle="modal"><button class="btn btn-success btn-pill btn-xs"><i class="fa fa-plus-circle"></i> Tambah Data</button></a>' : ''); ?>
                <div class="clearfix mg-t-15 mg-b-15"></div>
				...
				<table class="table table-bordered">
					...
					?>
                    	<tr>
                        	<td><?php echo(($data->akses($admin, 'rorderpim', 'update_status')=='Active') ? '<a href="#modal1" onclick="crud(\'rorderpim\', \'editdetail\', \''.base64_encode($hasil['id_trd']).'\')" data-toggle="modal">'.$hasil['nama_pro'].' - '.$hasil['kode_pro'].'</a>' : ''); ?></td>
        ...
        <div class="row row-sm">
            <div class="col-sm-12">
                <a href="<?php echo("$sistem/rorderpim"); ?>" title="Kembai">
