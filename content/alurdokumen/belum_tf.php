    ...
    <div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Dokumen Belum Tukar Faktur</li>
            </ol>
        </nav>
        <h4 class="content-title">Belum Tukar Faktur </h4>
    </div>
</div>
<?php
            ...
            <?php
				...
				$qMaster = "SELECT
					        ...
					        LEFT JOIN outlet AS B ON
                                A.id_out = B.id_out
                            WHERE
                                 A.tgl_tfk=:kode AND A.status_tfkkf='Belum Dikirim'";
