    ...
    <div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Dokumen Sudah Selesai Input Pajak </li>
            </ol>
        </nav>
        <h4 class="content-title">Selesai Input Pajak </h4>
    </div>
</div>
<?php
        ...
        <table class="table table-hover mg-b-0">
            <thead>
                <tr>
                    ...
                    <th><center>Dokumen Balik</center></th>
                </tr>
            </thead>
            <tbody>
            <?php
				...
				$qMaster = "SELECT
                            ...
                            WHERE
                                 A.tgl_tfk=:kode AND A.status_f_pajak='sudah terbit'";
			...
			?>
				<tr>
                    ...
                    <td><center><?php echo($data->tgldd ($hasil['created_at'])); ?></center></td>
