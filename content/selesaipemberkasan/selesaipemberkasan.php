<div class="content-header">
    <div>
        ...
        <h4 class="content-title">Selesai Pemberkasan Tukar Faktur - Serah Terima Dokumen Ke Bagian Koordinator TF</h4>
    </div>
</div>
<?php
...
<div class="content-body">
	<div class="row mg-b-10">
        <div class="col-sm-6">
            <?php echo(($data->akses($admin, $menu, 'A.create_status')==='Active') ? '<a href="'.$sistem.'/selesaipemberkasan/i"><button class="btn btn-primary btn-pill btn-xs"><i class="fa fa-plus-circle"></i> Tambah Data</button></a>' : ''); ?>
            ...
            <a href="<?php echo("$sistem/selesaipemberkasan"); ?>" title="Refresh"><button class="btn btn-info btn-pill btn-xs"><i class="fa fa-spinner"></i> Refresh</button></a>
