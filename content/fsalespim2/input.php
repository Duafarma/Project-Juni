<div class="content-header">
    <div>
        ...
        <h4 class="content-title">Input Data - Faktur Penjualan PIM Nego E-Katalog</h4>
    </div>
</div>
    ...
    <div class="component-section no-code">
        ...
        <div class="row row-sm">
            ...
            <div class="col-sm-3">
				...
				<select name="outlet" id="outlet" class="form-control select2" onchange="ceksalespim2()" required="required">
        ...
        <input type="hidden" name="hargapim" value="-" />
