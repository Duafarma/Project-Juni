<div class="content-header">
    <div>
        ...
        <h4 class="content-title">Selesai Faktur Pajak  - Serah Terima Dokumen Ke Bagian Pemberkasan Tukar Faktur</h4>
    </div>
</div>
<?php
...
<div class="content-body">
	<div class="row mg-b-10">
        <div class="col-sm-6">
            <?php echo(($data->akses($admin, $menu, 'A.create_status')==='Active') ? '<a href="'.$sistem.'/selesaifakturpajak/i"><button class="btn btn-primary btn-pill btn-xs"><i class="fa fa-plus-circle"></i> Tambah Data</button></a>' : ''); ?>
            ...
            <a href="<?php echo("$sistem/selesaifakturpajak"); ?>" title="Refresh"><button class="btn btn-info btn-pill btn-xs"><i class="fa fa-spinner"></i> Refresh</button></a>
