...
<div class="content-header">
    <div>
        ...
        <h4 class="content-title">Input Item - Faktur Penjualan B</h4>
    ...
    <div class="component-section no-code">
        ...
        <div class="row row-sm">
            <div class="col-sm-12">
                ...
                <a onclick="addmaximalb('addsalesb', 'outlet', 200)"><span class="badge badge-success"><i class="fa fa-plus-circle"></i> Add Data</span></a>
            </div>
        </div>
        <div class="clearfix mg-t-25 mg-b-25"></div>
        <div class="row row-sm">
