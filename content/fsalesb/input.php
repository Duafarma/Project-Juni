    ...
    <div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Faktur Penjualan B</li>
            </ol>
        </nav>
        <h4 class="content-title">Input Data - Faktur Penjualan B</h4>
    </div>
</div>
<div class="content-body">
    <div class="component-section no-code">
        ...
        <input type="hidden" name="namamodal" id="namamodal" value="fsalesb" readonly="readonly" />
        ...
        <div class="row row-sm">
            ...
            <div class="col-sm-3">
                ...
                <?php
                    $status = 'Active';
                    $idmg = 'MG000000000000000010';
                    $master = $conn->prepare("SELECT id_out, kode_out, nama_out FROM outlet WHERE status_out=:status AND id_mg=:idmg ORDER BY nama_out ASC");
                    $master->bindParam(':status', $status, PDO::PARAM_STR);
                    $master->bindParam(':idmg', $idmg, PDO::PARAM_STR);
                    $master->execute();
            ...
            <div class="col-sm-3 mg-t-10">
                <label>CCP <span class="tx-danger">*</span></label><br>
                <input type="radio" name="ccp" value="ada" required> Ada<br>
                <input type="radio" name="ccp" value="tidak ada"> Tidak Ada<br>
            </div>
            <div class="col-sm-3 mg-t-10">
                <label>Cito <span class="tx-danger">*</span></label><br>
                <input type="radio" name="cito" value="cito" required> Ya<br>
                <input type="radio" name="cito" value="ga cito"> Tidak<br>
            </div>
        </div><!-- row -->
        <div class="clearfix mg-t-25 mg-b-25"></div>
        <div class="row row-sm">
            <div class="col-sm-12">
                <a href="<?php echo("$sistem/fsalesb"); ?>" title="Batal"><button type="button" class="btn btn-secondary">Batal</button></a>
