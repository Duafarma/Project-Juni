<div class="content-header">
    <div>
        ...
        <h4 class="content-title">Pembelian Cendo</h4>
    </div>
</div>
<?php
...
var chart = new Highcharts.Chart({
	...
	title: {
		text: '<?php echo("GRAFIK TRANSAKSI PEMBELIAN CENDO"); ?>',
		x: -20 //center
	},
	subtitle: {
	...
	{ 
		...
		<?php
			...
			while($vbulan	= $rbulan->fetch(PDO::FETCH_ASSOC)){
                    ...
                    echo($jual . ","); // Pastikan data yang dihasilkan adalah angka dan dipisahkan koma
			}
		?>
		]
	},
