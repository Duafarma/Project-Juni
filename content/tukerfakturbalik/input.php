<div class="content-header">
    <div>
        ...
        <h4 class="content-title">Input Data - Tanda Terima Tukar Faktur Balik</h4>
    </div>
</div>
...
<div class="content-body">
    <div class="component-section no-code">
        ...
        <input type="hidden" name="nmenu" id="nmenu" value="tukerfakturbalik" readonly="readonly" />
        <input type="hidden" name="nact" id="nact" value="input" readonly="readonly" />
        <div class="form-row">
            <div class="form-group col-sm-12">
                <label>Tgl. Balik  <span class="tx-danger">*</span></label>
            ...
            <div class="form-group col-sm-12">
                <label>Tgl. Tuker Faktur  <span class="tx-danger">*</span></label>
                <input type="text" name="tanggal_tf" class="form-control datepicker"  value="<?php echo(date('Y-m-d')); ?>" placeholder="9999-99-99" required="required" />
            </div>
         ...
         <div class="row">
            <div class="form-group col-sm-12">
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-sm-4">
                        <a onclick="additem('tbllegal', 'jumlegal', 'legalfaktur')"><span class="badge badge-success"><i class="fa fa-plus-circle"></i> Add Single</span></a>
                    </div>
                </div>
            </div>
		</div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <a href="<?php echo("$sistem/tukerfakturbalik"); ?>" title="Batal"><button type="button" class="btn btn-secondary btn-xs">Batal</button></a>
...
function addMultipleRows() {
    var jumlahRow = parseInt(document.getElementById('jumlah_row') ? document.getElementById('jumlah_row').value : 1);
    ...
    // Konfirmasi jika jumlah row besar
    if (jumlahRow > 50) {
        if (!confirm('Anda akan menambahkan ' + jumlahRow + ' row sekaligus. Lanjutkan?')) {
            return;
        }
    }
    ...
    for (var i = 0; i < jumlahRow; i++) {
        (function(delayIndex) {
            setTimeout(function() {
                // sesuaikan nama group/field sesuai file ini
                additem('tbllegal', 'jumlegal', 'legalfaktur');
                completed++;
                if (completed === jumlahRow) {
                    // All rows added, initialize select2 if ada
                    setTimeout(function() {
                        initializeAllSelect2();
                        alert('Berhasil menambahkan ' + jumlahRow + ' row');
                        if (document.getElementById('jumlah_row')) document.getElementById('jumlah_row').value = '1';
                    }, 200);
                }
            }, delayIndex * 100);
        })(i);
...
function initializeAllSelect2() {
    ...
    setTimeout(function() {
        ...
        // Re-initialize all select2 elements
        $('.select2').select2({
