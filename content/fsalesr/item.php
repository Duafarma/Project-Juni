...
// Custom getproductsales for fsalesr (same concept as fpenggantianbarang)
...
function getproductsales(nomor, kode, produk, nama, code, harga, berat, kategori, satuanqty, satuan, bcode, tgled, gudang, stok, diskon){
    console.log('=== getproductsales CALLED (fsalesr override) ===');
...
function openProductModal(nomor, outlet) {
    ...
    $.ajax({
        url: usuper + "/modal/fsalesr/products.php",
        type: "POST",
        dataType: "text",
        data: {
            "m": mitra,
