<div class="content-header">
    <div>
        ...
        <h4 class="content-title">Penerimaan Barang DPE</h4>
    </div>
</div>
<?php
	...
	-->
        <div class="row row-sm">
            <div class="col-sm-12">
				...
				<?php echo(($data->akses($admin, 'rorderdpe', 'A.create_status')==='Active') ? '<a href="#modal1" onclick="crud(\'rorderdpe\', \'inputitem\', \''.$uniq.'\')" data-toggle="modal"><button class="btn btn-success btn-pill btn-xs"><i class="fa fa-plus-circle"></i> Tambah Data</button></a>' : ''); ?>
                <div class="clearfix mg-t-15 mg-b-15"></div>
				...
				<table class="table table-bordered">
					...
					?>
                    	<tr>
                        	<td><?php echo(($data->akses($admin, 'rorderdpe', 'update_status')=='Active') ? '<a href="#modal1" onclick="crud(\'rorderdpe\', \'editdetail\', \''.base64_encode($hasil['id_trd']).'\')" data-toggle="modal">'.$hasil['nama_pro'].' - '.$hasil['kode_pro'].'</a>' : ''); ?></td>
					...
					?>
						...
						<tr>
                        <td></td>
                        	<td colspan="7"><div align="right"><b>PPH 22 (0.3%)</b></div></td>
                        	<td><div align="right"><b><?php echo($data->angka($pph)); ?></b></div></td>
                        </tr> -->
						<tr>
                        <td></td>
        ...
        <div class="row row-sm">
            <div class="col-sm-12">
                <a href="<?php echo("$sistem/rorderdpe"); ?>" title="Kembai">
