    ...
    <div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Inventory Rhea</li>
            </ol>
        </nav>
        <h4 class="content-title">Inventory Rhea</h4>
    </div>
</div>
...
<div class="content-body">
    <div class="row mg-b-10">
        <div class="col-sm-6">
            ...
            <a href="<?php echo("$sistem/inventoryrhea"); ?>"><button class="btn btn-info btn-pill btn-xs"><i class="fa fa-spinner"></i> Refresh</button></a>
