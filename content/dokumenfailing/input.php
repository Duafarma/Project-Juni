<div class="content-header">
    <div>
        ...
        <h4 class="content-title">Input Data - Dokumen Failing</h4>
    </div>
</div>
...
<div class="content-body">
    <div class="component-section no-code">
        ...
        <input type="hidden" name="nmenu" id="nmenu" value="dokumenfailing" readonly="readonly" />
        <input type="hidden" name="nact" id="nact" value="input" readonly="readonly" />
        <div class="form-row">
            <div class="form-group col-sm-12">
                <label>Tgl. Failing  <span class="tx-danger">*</span></label>
         ...
         <div class="row">
            <div class="form-group col-sm-12">
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-sm-4">
                        <a onclick="additem('tbllegal', 'jumlegal', 'legalfailing')"><span class="badge badge-success"><i class="fa fa-plus-circle"></i> Add Single</span></a>
                    </div>
                </div>
            </div>
		</div>
...
function addMultipleRows() {
    ...
    for (var i = 0; i < jumlahRow; i++) {
        setTimeout(function() {
            additem('tbllegal', 'jumlegal', 'legalfailing');
            completed++;
