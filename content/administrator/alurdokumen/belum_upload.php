    ...
    <div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Dokumen Sudah Belum Upload Pajak </li>
            </ol>
        </nav>
        <h4 class="content-title">Belum Upload Pajak </h4>
    </div>
</div>
<?php
            ...
            <?php
				...
				$qMaster = "SELECT
					        ...
					        LEFT JOIN outlet AS B ON
                                A.id_out = B.id_out
                            WHERE
                                 A.tgl_tfk=:kode AND A.upload_f_pajak='belum'";
