<div class="content-header">
    <div>
        ...
        <h4 class="content-title">Input Data - Faktur Penggantian Barang retur</h4>
    </div>
</div>
    ...
    <div class="component-section no-code">
        ...
        <div class="row row-sm">
            ...
            <div class="col-sm-3">
				...
				<select name="outlet" id="outlet" class="form-control select2" onchange="ceksalespenggantianbarang()" required="required">
            ...
            <div class="col-sm-3 mg-t-10">
                ...
                <input type="text" name="nomorpo" class="form-control" placeholder="Ketik keterangan..." />
            </div>
            <div class="col-sm-6 mg-t-10">
                <label>Nomor Faktur Penjualan<span class="tx-danger">*</span></label>
				<select name="no_tfk_penjualan" id="no_tfk_penjualan" class="form-control select2" required="required">
                    <option value="">-- Pilih --</option>
