<div class="content-header">
    <div>
        ...
        <h4 class="content-title">Input Data - Selesai Failing - Serah Terima Faktur</h4>
    </div>
</div>
...
<div class="content-body">
    <div class="component-section no-code">
        ...
        <input type="hidden" name="nmenu" id="nmenu" value="selesaifailing" readonly="readonly" />
         ...
         <div class="row">
            <div class="form-group col-sm-12">
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-sm-4">
                        <a onclick="additem('tbllegal', 'jumlegal', 'legalselesai')"><span class="badge badge-success"><i class="fa fa-plus-circle"></i> Add Single</span></a>
                    </div>
                </div>
            </div>
		</div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <a href="<?php echo("$sistem/selesaifailing"); ?>" title="Batal"><button type="button" class="btn btn-secondary btn-xs">Batal</button></a>
...
function addMultipleRows() {
    ...
    for (var i = 0; i < jumlahRow; i++) {
        (function(delayIndex) {
            setTimeout(function() {
                additem('tbllegal', 'jumlegal', 'legalselesai');
                completed++;
