...
<?php
	...
	$read	= $conn->prepare("SELECT A.kode_ttr, A.tgl_ttr,  D.nama_apl, D.Alamat FROM transaksi_transferstock AS A LEFT JOIN aplikasi AS D ON A.id_app_to=D.id_apl WHERE A.id_ttr=:kode");
	...
	<body>
		...
		<table style="font-weight:bold;">
			...
			<tr>
				<td>Nama Cabang</td>
				<td><center>:</center></td>
				<td width="65%"><?php echo($view['nama_apl']); ?></td>
			</tr>
			<br />
			<br />
			<tr>
				<td>Alamat Cabang</td>
				<td><center>:</center></td>
				<td width="65%"><?php echo($view['Alamat']); ?></td>
			</tr>
			<br />
			<br />
			<tr>
