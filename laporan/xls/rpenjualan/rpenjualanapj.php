...
<?php
	...
	header("content-disposition:attachment; filename=report_penjualan_faktur_a.xls");
    	...
    	<table border="1">
            ...
            <?php
				...
				$qmaster ="SELECT 
				                    ...
				                    F.pengiriman_ola, 
				                    H.nama_rkb 
				                    FROM transaksi_fakturdetail AS A LEFT JOIN 
				                    transaksi_faktur AS B ON A.id_tfk=B.id_tfk LEFT JOIN 
