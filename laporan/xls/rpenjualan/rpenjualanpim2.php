...
<?php
	...
	// tambah filter untuk hargapim = '-'
	$hargapim = "AND B.hargapim='-'";
?>
    <head>
    ...
    <body>
		<table>
        	<tr>
            	<th colspan="18">REPORT PENJUALAN PIM NEGO E-KATALOG</th>
            </tr>
            <tr>
            	<td colspan="18"></td>
            </tr>
    	...
    	<table border="1">
            ...
            <?php
				...
				while($hasil= $master->fetch(PDO::FETCH_ASSOC)){
                    ...
                    // hitung total setelah diskon 11%
                    $total_tfd = (float) $hasil['total_tfd'];
                    $total_setelah_diskon11 = $total_tfd * (1 - 0.11);
            ?>
                <tr>
                    ...
                    <td><?php echo number_format($total_setelah_diskon11, 2, '.', ''); ?></td>
                    <td><center>Gudang P</center></td>
