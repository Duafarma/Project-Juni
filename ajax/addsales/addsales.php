<?php
	...
	$principleId = $secu->injection(@$_GET['principle']); // Add principle parameter
	$nomor	= ($jumlah + 1);
?>
<tr id="<?php echo("traddsales$nomor"); ?>">
    <td>
    <a href="javascript:void(0);" onclick="<?php echo("openProductModal($nomor, 'outlet'); return false;"); ?>">
    <div id="<?php echo("noproduct$nomor"); ?>">Pilih Produk</div>
    </a>
    ...
    <input type="hidden" name="namaproduk[]" id="<?php echo("pnamaproduk$nomor"); ?>" readonly="readonly" />
    <input type="hidden" name="principle_id[]" id="<?php echo("principle$nomor"); ?>" value="<?php echo($principleId); ?>" readonly="readonly" />
    </td>
    ...
    <td><div id="<?php echo("stoktampil$nomor"); ?>">-</div></td>
