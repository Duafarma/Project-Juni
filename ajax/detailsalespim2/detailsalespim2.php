<?php
	...
	$master	= $conn->prepare("SELECT
							...
							E.no_bcode,
							E.tgl_expired
							FROM transaksi_salesdetail_pim AS A
							...
							LEFT JOIN produk_stokdetail AS E ON A.id_psd=E.id_psd WHERE A.id_tsl=:kode");
