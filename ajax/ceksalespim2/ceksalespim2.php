<?php
	...
	$gabung	= '.05.01/SJ/'.$view['kode_kot'].'/'.$data->romawi(date('m')).'/'.date('y');
	$gobong	= '.05.01/FKT/'.$view['kode_kot'].'/'.$data->romawi(date('m')).'/'.date('y');
	$inv	= $data->transcodepim2($gabung, 'sj_tfk', 'transaksi_faktur_pim');
	$fak	= $data->transcodepim2($gobong, 'kode_tfk', 'transaksi_faktur_pim');
