...
<tr id="<?php echo("item$nomor"); ?>">
    ...
    <td><input type="text" name="harga_a[]" class="inputangka" placeholder="0" required="required" /></td>
    <td><input type="text" name="harga_b[]" class="inputangka" placeholder="0" required="required" /></td>
    <td><input type="text" name="harga_c[]" class="inputangka" placeholder="0" required="required" /></td>
    <td>
    <center>
    	<a onclick="<?php echo("delprohpim($nomor)"); ?>"><span class="badge badge-danger"><i class="fa fa-times-circle"></i></span></a>
	</center>
	</td>
</tr>
<?php
