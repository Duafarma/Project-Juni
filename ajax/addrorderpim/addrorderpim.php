<?php
	...
	$tabel	= '<tr id="traddorder'.$nomor.'">
					...
					<td><input type="text" name="jumlah[]" id="pjumlah'.$nomor.'" class="inputangka" value="1" onchange="jumlahorderpim('.$nomor.')" onkeyup="angka(this)" placeholder="0" /></td>
					<td><input type="text" name="diskon[]" id="pdiskon'.$nomor.'" class="inputangka" value="'.$diskon.'" onchange="hitungorderpim('.$nomor.')" placeholder="0" /></td>
