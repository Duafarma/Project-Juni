...
$nomor = ($jumlah + 1);
?>
<tr id="<?php echo ("addProductReturTransfer$nomor"); ?>">
    <td>
        <a href="#modal2"
            onclick="addProductReturTransferModal('<?php echo $nomor; ?>', 'showProductReturTransfer', '<?php echo $type; ?>', '<?php echo $fromnm; ?>', '<?php echo $from; ?>')"
            data-toggle="modal">
            <div id="<?php echo ("noproduct$nomor"); ?>">Pilih</div>
        </a>
        <input type="hidden" name="product[]" id="<?php echo ("product$nomor"); ?>" class="itemproduct"
            readonly="readonly" />
    ...
    <td>
        <input type="text" name="harga[]" id="<?php echo ("pharga$nomor"); ?>" class="inputangka" onkeyup="angka(this)"
            placeholder="0" readonly="readonly" />
    </td>
    <td>
        <input type="text" name="jumlah[]" id="<?php echo ("pjumlah$nomor"); ?>" class="inputangka text-right"
            onchange="<?php echo ("cekProdukReturTransfer($nomor)"); ?>" onkeyup="angka(this)" placeholder="0"
            required="required" />
    </td>
    <td>
    ...
    <td>
        <center>
            <a onclick="<?php echo ("deleteProductReturTransfer($nomor)"); ?>"><span class="badge badge-danger"><i
