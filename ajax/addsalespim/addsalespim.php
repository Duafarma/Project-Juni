...
<tr id="<?php echo("traddsales$nomor"); ?>">
	<td>
        ...
        <a href="#modal1" onclick="<?php echo("addsalespim($nomor, 'outlet')"); ?>" data-toggle="modal">
	...
	<td><input type="text" name="jumlah[]" id="<?php echo("pjumlah$nomor"); ?>" class="inputangka" value="1" onchange="<?php echo("jumlahsalespim($nomor)"); ?>" onkeyup="angka(this)" placeholder="0" /></td>
	...
	<td><input type="text" name="diskon[]" id="<?php echo("pdiskon$nomor"); ?>" class="inputangka" value="<?php echo($diskon); ?>" onchange="<?php echo("hitungsalespim($nomor)"); ?>" placeholder="0" readonly="readonly" /></td>
    ...
    <td>
    <center>
    	<a onclick="<?php echo("delsalespim($nomor)"); ?>"><span class="badge badge-danger"><i class="fa fa-times-circle"></i></span></a>
	</center>
	</td>
</tr>
<?php
