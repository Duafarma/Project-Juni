<?php
	...
	$jumlah	= (empty($jumlah) || !is_numeric($jumlah)) ? 0 : intval($jumlah);
	$diskon	= (empty($diskon) || !is_numeric($diskon)) ? 0 : $diskon;
	
	$nomor	= ($jumlah + 1);
?>
<tr id="<?php echo("traddsalesk$nomor"); ?>">
    <td>
    <a href="#modal1" onclick="<?php echo("addsalesk($nomor, 'outlet')"); ?>" data-toggle="modal">
	...
	<td><input type="text" name="jumlah[]" id="<?php echo("pjumlah$nomor"); ?>" class="inputangka" value="1" onchange="<?php echo("jumlahsalesk($nomor)"); ?>" onkeyup="angka(this)" placeholder="0" /></td>
	...
	<td><input type="text" name="diskon[]" id="<?php echo("pdiskon$nomor"); ?>" class="inputangka" value="<?php echo($diskon); ?>" onchange="<?php echo("hitungsalesk($nomor)"); ?>" placeholder="0" readonly="readonly" /></td>
    ...
    <td>
    <center>
    	<a onclick="<?php echo("delsalesk($nomor)"); ?>"><span class="badge badge-danger"><i class="fa fa-times-circle"></i></span></a>
	</center>
	</td>
</tr>
<?php
