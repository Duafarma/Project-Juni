...
<tr id="<?php echo("traddsales$nomor"); ?>">
    <td>
    <a href="#modal1" onclick="<?php echo("addsalesretur($nomor, 'supplier')"); ?>" data-toggle="modal">
	...
	<td><input type="text" name="jumlah[]" id="<?php echo("pjumlah$nomor"); ?>" class="inputangka" value="1" onchange="<?php echo("jumlahsalesretur($nomor)"); ?>" onkeyup="angka(this)" placeholder="0" /></td>
	...
	<td><input type="text" name="diskon[]" id="<?php echo("pdiskon$nomor"); ?>" class="inputangka" value="<?php echo($diskon); ?>" onchange="<?php echo("hitungsalesretur($nomor)"); ?>" placeholder="0" readonly="readonly" /></td>
