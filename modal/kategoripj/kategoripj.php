...
?>
        ...
        <input type="hidden" name="nmenu" id="nmenu" value="kategoripj" readonly="readonly" />
        <input type="hidden" name="nact" id="nact" value="input" readonly="readonly" />
        <div class="modal-body">
            <div class="row">
                <div class="form-group col-md-12">
                    <label>Nama Kategori Produk <span class="tx-danger">*</span></label>
                    <input type="text" name="nama_produk_jadi" class="form-control" placeholder="Type here..." required="required" />
...
<?php
		...
		$read	= $conn->prepare("SELECT nama_produk_jadi FROM kategori_produk_jadi WHERE id_pj=:kode");
...
?>
        ...
        <div class="modal-body">
            <div class="row">
                <div class="form-group col-md-12">
                    <label>Nama Kategori Produk <span class="tx-danger">*</span></label>
                    <input type="text" name="nama_produk_jadi" class="form-control" value="<?php echo($view['nama_produk_jadi']); ?>" placeholder="Type here..." required="required" />
                    <div id="imgloading"></div>
                </div>
			</div>
        </div>
