				...
				<table id="example1" class="tabelgetdata">
					<thead>
						<tr>
							...
							<th>Nama</th>
							<th>
								<center>Batchcode</center>
							</th>
							<th>
								<center>Tgl. ED</center>
							</th>
							<th>
								<center>Gudang</center>
							</th>
							<th>
								<div align="right">Stok</div>
							</th>
							<th>
					...
					<tbody>
						...
						?>
							<tr
								onClick="<?php echo ("showProductReturTransfer('$nomor', '$hasil[id_i_r]', '$hasil[id_pro]', '$hasil[nama_pro]', '$hasil[kode_pro]', '$hasil[harga_phg]', '$hasil[berat_pro]', '$hasil[nama_kpr]', '$hasil[satuan_kpr]', '$hasil[nama_spr]', '$hasil[no_bcode]', '$hasil[ed]', '$hasil[sisa]', '$hasil[id_r_d]', '$hasil[tanggal]', '$hasil[gudang]')"); ?>">
								<td><?php echo ($hasil['kode_pro']); ?></td>
								<td><?php echo ($hasil['nama_pro']); ?></td>
								<td>
									<center><?php echo ($hasil['no_bcode']); ?></center>
								</td>
								<td>
									<center><?php echo ($hasil['ed']); ?></center>
								</td>
								<td>
									<center><?php echo ($hasil['gudang']); ?></center>
								</td>
								<td>
									<div align="right"><?php echo ($hasil['sisa']); ?></div>
								</td>
								<td>
									<div align="right"><?php echo ($data->angka($hasil['harga_phg'])); ?></div>
								</td>
							</tr>
						<?php $no++;
						} ?>
...
<script type="text/javascript"
	src="<?php echo ($data->sistem('url_sis') . '/DataTables/datatables.min.js'); ?>"></script>
<script type="text/javascript">
	$('#example1').DataTable({
		language: {
