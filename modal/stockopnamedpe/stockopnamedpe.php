...
<div class="modal-header">
            <h6 class="modal-title" id="exampleModalLabel">Data Hitung Fisik DPE</h6>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true"><i class="fa fa-times-circle"></i></span>
            </button>
        </div>
        <form id="formtransaksi" action="#" method="post" autocomplete="off">
            <input type="hidden" name="namamodal" id="namamodal" value="stockopnamedpe" readonly="readonly" />
            <input type="hidden" name="nmenu" id="nmenu" value="stockopnamedpe" readonly="readonly" />
            <input type="hidden" name="namamenu" value="<?php echo($modal); ?>" readonly="readonly" />
            <input type="hidden" name="keycode" value="<?php echo($kode); ?>" readonly="readonly" />
       <div class="modal-body">
            <div class="row">
	            <div class="form-group col-md-12">
                	<h6>Masukan Qty hasil SO</h6>
                	<h6><?php echo($view['nama_pro']); ?> dengan Nomor Batch  <?php echo($view['no_bcode']); ?>  </h6>
                    ...
                    <td>
							...
							<input type="number" name="qty_so" id="qty_so" class="form-control"/>
					</td>
                    </div>
