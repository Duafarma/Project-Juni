...
?>
        ...
        <div class="modal-body">
            <div class="row">
                <div class="form-group col-md-12">
                    <label>Kode Provinsi <span class="tx-danger">*</span></label>
                    <input type="number" name="kode_p" class="form-control" placeholder="Type here..." required="required" />
                    <div id="imgloading"></div>
                </div>
			</div>
        </div>
...
<?php
		...
		$read	= $conn->prepare("SELECT nama_rpo, kode_p FROM regional_provinsi WHERE id_rpo=:kode");
...
?>
        ...
        <div class="modal-body">
            <div class="row">
                <div class="form-group col-md-12">
                    <label>Provinsi <span class="tx-danger">*</span></label>
                    <input type="number" name="kode_p" class="form-control" value="<?php echo($view['kode_p']); ?>" placeholder="Type here..." required="required" />
                    <div id="imgloading"></div>
                </div>
			</div>
        </div>
