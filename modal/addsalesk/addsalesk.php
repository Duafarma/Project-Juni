...
?>
    ...
    <div class="modal-header">
        <h6 class="modal-title" id="exampleModalLabel">Search Product Konsinyasi</h6>
    ...
    <div class="modal-body">
        <div class="row">
			...
			<table id="example1" class="tabelgetdata">
				...
				?>
                	<tr onClick="<?php echo("getproductsalesk('$nomor', '$hasil[id_psd]', '$hasil[id_pro]', '$hasil[nama_pro]', '$hasil[kode_pro]', '$hasil[harga_phg]', '$hasil[berat_pro]', '$hasil[nama_kpr]', '$hasil[satuan_kpr]', '$hasil[nama_spr]', '$hasil[no_bcode]', '$hasil[tgl_expired]', '$hasil[gudang]', '$hasil[sisa_psd]', '$hasil[persen_pds]')"); ?>">
