...
?>
        ...
        <div class="modal-body">
            ...
            <div class="row">
			 ...
			 <div class="row">
                <div class="form-group col-md-6">
                    <label>CCP<span class="tx-danger">*</span></label>
                    <select name="ccp" class="form-control" required="required">
                    	<option value="">-- Pilih Data --</option>
...
<?php
		...
		$read	= $conn->prepare("SELECT kode_pro, nama_pro,nama_p, berat_pro,kekuatan,zat_pre, id_kpr, id_spr, rak_pro, section_pro, minstok_pro, kode_produk_jadi, kategori_obat, no_nie, tgl_nie, new_code, ccp FROM produk WHERE id_pro=:kode");
            ...
            <div class="row">
			 ...
			 <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <select name="ccp" class="form-control" required="required">
                        <option value="">-- Pilih Data --</option>
                        <option value="ya" <?php echo ($view['ccp'] == 'ya') ? 'selected' : ''; ?>>Ya</option>
                        <option value="tidak" <?php echo ($view['ccp'] == 'tidak') ? 'selected' : ''; ?>>Tidak</option>
                    </select>
                </div>
            </div>
