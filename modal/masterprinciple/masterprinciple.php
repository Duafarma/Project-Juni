...
?>
        <div class="modal-header">
            <h6 class="modal-title" id="exampleModalLabel">Input Data - Master Principle</h6>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true"><i class="fa fa-times-circle"></i></span>
            </button>
        </div>
        <form id="formtransaksi" action="#" method="post" autocomplete="off">
        <input type="hidden" name="nmenu" id="nmenu" value="masterprinciple" readonly="readonly" />
        <input type="hidden" name="nact" id="nact" value="input" readonly="readonly" />
        <div class="modal-body">
            <div class="row">
                <div class="form-group col-md-12">
                    <label>Nama Principle <span class="tx-danger">*</span></label>
                    <input type="text" name="nama_principle" class="form-control" placeholder="Type here..." required="required" />
...
<?php
		...
		$read	= $conn->prepare("SELECT nama_principle FROM master_principle WHERE id_mp=:kode");
...
?>
        ...
        <div class="modal-body">
            <div class="row">
                <div class="form-group col-md-12">
                    <label>nama_principle <span class="tx-danger">*</span></label>
                    <input type="text" name="nama_principle" class="form-control" value="<?php echo($view['nama_principle']); ?>" placeholder="Type here..." required="required" />
                    <div id="imgloading"></div>
                </div>
			</div>
        </div>
            ...
            <div class="row">
                <div class="form-group col-md-12">
                    <div class="alert alert-danger alert-dismissible mg-b-0 fade show" role="alert">
                        <strong>Informasi!</strong> Hapus data masterprinciple?
                    </div>
                    <div id="imgloading"></div>
                </div>
			</div>
