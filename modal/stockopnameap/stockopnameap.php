...
<div class="modal-header">
        ...
        <div class="modal-body">
            <div class="row">
	            <div class="form-group col-md-12">
                	<h6>Apakah Sudah Sesuai Dengan Fisik Yang Di cek?</h6>
                	<h6>Nama Produk   <?php echo($view['nama_pro']); ?> dan Nomor Batch  <?php echo($view['no_bcode']); ?>  </h6>
                    <div class="table-responsive">

                    <td>
                            <label>Stockopname <span class="tx-danger">*</span></label>
							<input type="number" name="awal" id="awal" value="<?php echo($view['qty_so']); ?>" class="form-control" required readonly="readonly"/>
					</td>
                    </div>
