<?php
	...
	switch($modal){
		...
		$read	= $conn->prepare("SELECT fak_tre, tglfak_tre,sj_tre, tgl_limit, tgl_tre FROM transaksi_receive WHERE id_tre=:kode");
            ...
            <div class="row">
                <div class="form-group col-md-6">
                 ...
                 <div class="form-group col-md-6">
                    ...
                    <input type="text" name="sj_tre" class="form-control" value="<?php echo($view['sj_tre']); ?>" placeholder="Type here..." required="required" />
                </div>
                <div class="form-group col-md-6">
...
?>
        ...
        <div class="modal-header">
            <h6 class="modal-title" id="exampleModalLabel">Input Item DPE - Receive Order</h6>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true"><i class="fa fa-times-circle"></i></span>
            </button>
        </div>
