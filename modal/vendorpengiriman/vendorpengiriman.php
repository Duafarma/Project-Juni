...
?>
        <div class="modal-header">
            <h6 class="modal-title" id="exampleModalLabel">Input Data - Master Data Vendor Pengiriman</h6>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true"><i class="fa fa-times-circle"></i></span>
            </button>
        </div>
        <form id="formtransaksi" action="#" method="post" autocomplete="off">
        <input type="hidden" name="nmenu" id="nmenu" value="vendorpengiriman" readonly="readonly" />
        <input type="hidden" name="nact" id="nact" value="input" readonly="readonly" />
        <div class="modal-body">
            <div class="row">
                <div class="form-group col-md-12">
                    <label>Nama Vendor <span class="tx-danger">*</span></label>
                    <input type="text" name="nama_vendor" class="form-control" placeholder="Type here..." required="required" />
                </div>
            </div>
        </div>
...
<?php
		...
		$read	= $conn->prepare("SELECT nama_vendor FROM vendor_pengiriman WHERE id_vendor=:kode");
...
?>
        ...
        <div class="modal-body">
            <div class="row">
                <div class="form-group col-md-12">
                    <label>Nama Vendor <span class="tx-danger">*</span></label>
                    <input type="text" name="nama_vendor" class="form-control" value="<?php echo($view['nama_vendor']); ?>" placeholder="Type here..." required="required" />
                </div>
            </div>
        </div>
        <div class="modal-footer">
