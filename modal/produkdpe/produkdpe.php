...
?>
        <div class="modal-header">
            <h6 class="modal-title" id="exampleModalLabel">Input Data - Produk DPE</h6>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true"><i class="fa fa-times-circle"></i></span>
            </button>
        </div>
        <form id="formmenu" action="#" method="post" autocomplete="off">
        <input type="hidden" name="namamodal" id="namamodal" value="produkdpe" readonly="readonly" />
...
?>
        <div class="modal-header">
            <h6 class="modal-title" id="exampleModalLabel">Update Data - Produk DPE</h6>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true"><i class="fa fa-times-circle"></i></span>
            </button>
        </div>
        ...
        <div class="modal-body">
            ...
            <div class="row">
                <div class="form-group col-md-6">
                    <label>Kategori Obat <span class="tx-danger">*</span></label>
                    <input type="text" name="kategori_obat" class="form-control" value="<?php echo($view['kategori_obat']); ?>" placeholder="ex. Rak A" readonly/>
                </div>
                 <div class="form-group col-md-6">
                    <label>Kode Produk jadi <span class="tx-danger">*</span></label>
            ...
            <div class="row">
                <div class="form-group col-md-12">
                    <div class="alert alert-danger alert-dismissible mg-b-0 fade show" role="alert">
                        <strong>Informasi!</strong> Hapus data produk DPE?
                    </div>
                    <div id="imgloading"></div>
                </div>
			</div>
