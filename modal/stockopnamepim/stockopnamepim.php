...
<div class="modal-header">
            <h6 class="modal-title" id="exampleModalLabel">Data Hitung Fisik PIM</h6>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true"><i class="fa fa-times-circle"></i></span>
            </button>
        </div>
        <form id="formtransaksi" action="#" method="post" autocomplete="off">
            <input type="hidden" name="namamodal" id="namamodal" value="stockopnamepim" readonly="readonly" />
            <input type="hidden" name="nmenu" id="nmenu" value="stockopnamepim" readonly="readonly" />
            <input type="hidden" name="namamenu" value="<?php echo($modal); ?>" readonly="readonly" />
            <input type="hidden" name="keycode" value="<?php echo($kode); ?>" readonly="readonly" />
       <div class="modal-body">
            <div class="row">
