-- Tabel untuk menyimpan histori retur konsinyasi

SET SQL_MODE = "NO_AUTO_VALUE_ON_ZERO";
START TRANSACTION;
SET time_zone = "+00:00";

-- Tabel Header Retur Konsinyasi
CREATE TABLE IF NOT EXISTS `transaksi_retur_konsinyasi` (
...
-- Tabel Detail Retur Konsinyasi
CREATE TABLE IF NOT EXISTS `transaksi_retur_konsinyasi_detail` (
