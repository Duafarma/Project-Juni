<?php
	...
	if($valid==false){
		...
		$master	= $conn->prepare("SELECT id_rpo, nama_rpo,kode_p FROM regional_provinsi WHERE nama_rpo LIKE '%$cari%' ORDER BY nama_rpo ASC LIMIT :mulai, :maxi");
		...
		while($hasil= $master->fetch(PDO::FETCH_ASSOC)){
			...
			$tabel	.= '<tr><td><center>'.$no.'</center></td><td>'.$hasil['nama_rpo'].'</td><td>'.$hasil['kode_p'].'</td><td><center>'.$edit.$delete.'</center></td></tr>';
		}
