<?php
	...
	if($valid==false){
		...
		$qJumlah = "SELECT
						COUNT(*) AS total
					FROM
						serah_terima_failing_detail AS A
		...
		while($hasil= $master->fetch(PDO::FETCH_ASSOC)){
			...
			$tabel	.= '<tr><td><center>'.$no.'</center></td><td>'.$hasil['kode_tfk'].'</td><td>'.$hasil['nama_out'].'</td><td>'.$hasil['created_at'].'</td><td>'.$hasil['status_serahterima_failing'].'</td></tr>';
		}
